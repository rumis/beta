...
func GetChatContextString(chatId string) (string, error) {
	return "", nil
}
                ...
                <div class="flex-col gap-1 md:gap-3">
                    <div class="flex flex-grow flex-col max-w-full">
                        <div data-message-author-role="user"
                            ...
                            <div class="">
								<p id="chat_room_request_{{.}}">hello </p>
							</div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="pt-0.5">
                        ...
                        <div class="relative p-1 rounded-sm h-9 w-9 text-white flex items-center justify-center"
                            ...
                            <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon-sm" role="img"><text x="-9999" y="-9999">ChatGPT</text>
                    ...
                    <div class="flex flex-grow flex-col max-w-full">
                        <div data-message-author-role="assistant"
                            ...
                            <div class="markdown prose w-full break-words dark:prose-invert dark">
                                <p id="chat_room_request_{{.}}">thank you!</p>
                            </div>
                        </div>
                    </div>
                </div>
